...
```bash
python3 skills/lisa-ppt/scripts/icon_sync.py <project_path> tabler-outline/home tabler-outline/bulb simple-icons/github
```
...
```bash
rg --files "skills/lisa-ppt/templates/icons/tabler-outline" -g '*chart*.svg'
rg --files "skills/lisa-ppt/templates/icons/simple-icons" -g '*github*.svg'
```
