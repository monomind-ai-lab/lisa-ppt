...
```bash
python3 skills/lisa-ppt/scripts/visualization_recall.py validate <family/key> [<family/key> ...]
python3 skills/lisa-ppt/scripts/visualization_recall.py validate --legacy-bare <legacy-key> [...]
```
