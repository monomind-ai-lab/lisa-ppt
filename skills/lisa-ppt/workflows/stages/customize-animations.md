...
Unless an all-motion disable bypasses it, validate an existing sidecar first: `python3 skills/lisa-ppt/scripts/animation_config.py validate <project_path>`.
