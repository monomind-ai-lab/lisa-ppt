...
```bash
python3 skills/lisa-ppt/scripts/animation_config.py list-groups <project>   # real anchors after regrouping
python3 skills/lisa-ppt/scripts/animation_config.py scaffold <project>      # neutral editable scaffold (effect: none, {} placeholders)
python3 skills/lisa-ppt/scripts/animation_config.py validate <project>      # before export
python3 skills/lisa-ppt/scripts/svg_to_pptx.py <project>                    # reads <project>/animations.json automatically
```
...
```bash
python3 skills/lisa-ppt/scripts/sound_sync.py list --query <term>                       # optional exact filtering after the vocabulary is in context
python3 skills/lisa-ppt/scripts/sound_sync.py <project_path> <namespace>/<sound_id> [...]  # materialize only the chosen ids
```
...
```bash
python3 skills/lisa-ppt/scripts/svg_to_pptx.py <project> -t push --transition-duration 0.6
python3 skills/lisa-ppt/scripts/svg_to_pptx.py <project> -t none
python3 skills/lisa-ppt/scripts/svg_to_pptx.py <project> --auto-advance 5            # kiosk playback
python3 skills/lisa-ppt/scripts/svg_to_pptx.py <project> -t none --auto-advance 5
```
