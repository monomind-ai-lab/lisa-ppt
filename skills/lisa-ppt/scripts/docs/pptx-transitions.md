...
~~~bash
python3 skills/lisa-ppt/scripts/pptx_animations.py --describe-transition page_curl
python3 skills/lisa-ppt/scripts/pptx_animations.py --describe-transition diamond
~~~
