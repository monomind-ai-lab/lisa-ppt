...
```bash
python3 skills/lisa-ppt/scripts/pptx_to_svg.py source.pptx \
  -o /path/to/workspace --inheritance-mode both --roundtrip
python3 skills/lisa-ppt/scripts/svg_to_pptx.py /path/to/workspace \
...
scripts = Path("skills/lisa-ppt/scripts")
