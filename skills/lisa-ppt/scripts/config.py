...
# config consumers.
SVG_CONSTRAINTS = {
    'authority': 'skills/lisa-ppt/references/shared-standards.md',
    'core_authority': 'skills/lisa-ppt/references/shared-standards-core.md',
    'conditional_authorities': {
        'effects': 'skills/lisa-ppt/references/svg-effects.md',
        'native_data': 'skills/lisa-ppt/references/native-data-interface.md',
        'pptx_structure': 'skills/lisa-ppt/references/pptx-structure-interface.md',
    },
    'validator': 'skills/lisa-ppt/scripts/svg_quality_checker.py',
}
