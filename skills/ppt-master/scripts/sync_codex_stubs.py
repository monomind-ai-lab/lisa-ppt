...
redirect body pointing at the canonical skills/<name>/ directory. The
skills/ tree is the single source of truth; stubs are generated artifacts and
...
SYNC_CMD = "python3 skills/ppt-master/scripts/sync_codex_stubs.py"
